  ...
  <div class="cover-container d-flex w-100 h-100 p-0 mx-auto flex-column">
    <main role="main" class="inner container h-100 d-flex justify-content-center align-items-center">
      <div class="form-container">
        <h2 class="mb-3">Sign In (Student)</h2>
        ...
        <form method="POST" action="{{ route('student_login') }}">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name" :value="old('name')" required autofocus aria-describedby="emailHelp" required>
          </div>
          <div class="form-group">
            <label for="code">Student Code :</label>
            <input type="code" class="form-control" id="code" name="code" required autocomplete="current-password" required>
          </div>
