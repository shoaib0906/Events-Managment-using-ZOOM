          ...
          <div class="card-body">
                ...
                <div class="form-group">
                  <label>Date:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="date"  value="{{ old('date', isset($announce) ? date('m/d/Y',strtotime($announce->date)) : '') }}" class="form-control datetimepicker-input" data-target="#reservationdate"/>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="">
                    ...
                    <input type="text" class="form-control" id="time24" name="start_time" data-inputmask-alias="datetime" value="{{ old('start_time', isset($announce) ? $announce->start_time : '') }}"  data-inputmask-inputformat="HH:MM" data-inputmask-placeholder="hh:mm">
                  </div>
                </div>
            ...
            <div class="">
                <div class="form-group " style="text-align: right;">
                  <button type="submit" class="btn btn-success pull-right">  Update Announcement</button>
                </div>
              </div>
