              ...
              <div class="card-header">
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-sm-6 " style="text-align: right;">
                    <a href="{{route('resource.create')}}" class="btn btn-sm btn-success"> Add New Resource  <i class="fa fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
                  ...
                  <tr>
                    ...
                    <td>
                       ...
                       <!--  <a class="btn btn-xs btn-primary" href="{{route('users.show',$usr->id)}}">
                        ...
                        <a class="btn btn-xs  btn-info" href="{{route('resource.edit',$usr->id)}}">
                ...
                <div class="modal fade" id="mymodal{{$usr->id}}">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form action="{{ route('resource.destroy', $usr->id) }}" method="POST">
                            <input type="hidden" name="_method" value="DELETE">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
